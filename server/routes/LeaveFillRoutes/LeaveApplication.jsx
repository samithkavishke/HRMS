...
router.post("/", (req, res) => {
  ...
  console.log("LeaveApplication.jsx is Running");
 /* A query to get the number of days of leave from the database. */
  pool.query(
        ...
        (err, row2, field) => {
          ...
          result1 =
            result1.length > 0
              ...
              : [
                  {
                    employee_id: req.body.employerID,
          ...
          const total_valid_leaves = values.length > 0 ? values[0] : 0;
          const total_taken = result2[0].total;
          const remain = total_valid_leaves - total_taken;
          // console.log("total_valid_leaves");
          // console.log(remain);
